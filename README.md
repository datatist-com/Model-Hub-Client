...
当前前端已实现菜单级别的权限过滤，页面内的细粒度权限控制（如按钮级别的只读/可编辑区分、数据行级别的权限过滤等）将在后端 API 对接时完善。

| 功能模块 | 系统管理员 | 建模工程师 | 数据工程师 | 业务运营 | 项目管理员 | 项目成员 |
|----------|:---:|:---:|:---:|:---:|:---:|:---:|
| 仪表盘 | 全部 | 全部 | 全部 | 全部 | 全部 | 全部 |
| 数据源管理 | 全部 | 全部 | 全部 | — | 全部 | — |
| 特征源表管理 | 全部 | 全部 | — | — | — | — |
| 用户画像管理 | 全部 | 全部 | 查看 / 期数新增 | — | 查看 / 期数新增 | — |
| 目标管理 | 全部 | 全部 | 查看 / 期数新增 | — | 查看 / 期数新增 | — |
| 模型管理 | 全部 | 全部 | — | — | — | — |
| 评分生成 | 全部 | 全部 | 全部 | 全部 | 全部 | 全部 |
| 运营人群包 | 全部 | 全部 | 全部 | 全部 | 全部 | 全部 |
| 用户管理 | 所有角色 | — | — | — | 仅项目成员 | — |
| 日志查看 | 全部 | — | — | — | — | — |
